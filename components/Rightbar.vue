...
const layoutValue = reactive(layoutStore.layoutValue);
...
sessionStorage.setItem("resetValue", JSON.stringify(state.resetValue));
...
function resetLayoutValue() {
  ...
  document.documentElement.setAttribute("data-sidebar-size", "lg");
  layoutStore.changeSidebarColor(reset.sidebarColor);
  layoutStore.changeLayoutType(reset.layoutType);
  layoutStore.changeLayoutWidth(reset.layoutWidth);
  layoutStore.changeSidebarSize(reset.sidebarSize);
  layoutStore.changeSidebarImage(reset.sidebarImage);
  layoutStore.changeSidebarColor(reset.sidebarColor);
  layoutStore.changeSidebarView(reset.sidebarView);
  layoutStore.changeVisibility(reset.visibility);
  layoutStore.changePosition(reset.position);
}
...
function gradiantColor() {
  layoutStore.changeSidebarColor("gradient");
}
...
const preloader = computed({
  get() {
    return layoutValue.preloader;
  },
  set() {
    return layoutStore.changePreloader();
  },
});
const mode = computed({
  get() {
    return layoutValue.mode;
  },
  set() {
    layoutStore.changeMode();
    // layoutStore.changeTopbar()
  },
});
const sidebarSize = computed({
  get() {
    return layoutValue.sidebarSize;
  },
  set(sidebarSize) {
    return layoutStore.changeSidebarSize(sidebarSize);
  },
});
const layoutWidth = computed({
  get() {
    return layoutValue.layoutWidth;
  },
  set(width) {
    if (width == "boxed") {
...
const position = computed({
  get() {
    return layoutValue.position;
  },
  set(position) {
    return layoutStore.changePosition(position);
  },
});
const topbar = computed({
  get() {
    return layoutValue.topbar;
  },
  set() {
    layoutStore.changeTopbar();
  },
...
const sidebarView = computed({
  get() {
    return layoutValue.sidebarView;
  },
  set(sidebarView) {
    return layoutStore.changeSidebarView(sidebarView);
  },
});
const sidebarColor = computed({
  get() {
    return layoutValue.sidebarColor;
  },
  set(sidebarColor) {
...
const sidebarImage = computed({
  get() {
    return layoutValue.sidebarImage;
  },
  set(sidebarImage) {
...
const visibility = computed({
  ...
  set(visibility) {
    ...
    layoutStore.changeVisibility(visibility);
  },
});
...
<template>
  <div>
    ...
    >
      <div
        class="offcanvas-header d-flex align-items-center bg-primary bg-gradient p-3"
      >
        <div class="me-2">
      ...
      <div class="offcanvas-body p-0">
        <simpleBar class="h-100">
          <div class="p-4">
              ...
              <div class="row">
                ...
                <div class="col" cols="4">
                  <div class="form-check card-radio">
                    ...
                    />
                    <label
                      class="form-check-label p-0 avatar-md w-100 px-2 shadow-sm"
            ...
            <div
              v-if="layoutType == 'vertical' || layoutType == 'horizontal'"
              id="layout-width"
            >
              <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">
                Layout Width
              ...
              <div class="row">
                <div class="col" cols="4">
                  <div class="form-check sidebar-setting card-radio">
                    <input
                      ...
                      value="light"
                      @click="onSideBarColorClick('light')"
                    />
                    <label
                      class="form-check-label p-0 avatar-md w-100"
                ...
                <div class="col" cols="4">
                  <div class="form-check sidebar-setting card-radio">
                    <input
                      ...
                      value="dark"
                      @click="onSideBarColorClick('dark')"
                    />
                    <label
                      class="form-check-label p-0 avatar-md w-100"
                ...
                <div class="col" cols="4">
                  <button
                    ...
                    data-bs-toggle="#collapseBgGradient"
                    @click="onSideBarColorClick('gradient')"
                  >
                    <!-- v-b-target.collapseBgGradient
